      ...
      <div className="search-books">
          ...
          <div className="search-books-input-wrapper">
            ...
            */
            ...
            {showingSearchTerms.length !== 0 && showingSearchTerms.map((searchterm) => (
              <option className="search-term" value={searchterm}>{searchterm}</option>
            ))}
            </select>
        ...
        <div className="search-books-results">
          ...
          {searchedBooks !== [] && (searchedBooks.map((book) => (
            <li key={searchedBook.id} className='book-list-item'>
              <div className="book">
                <div className="book-top">
                  <div className="book-cover" style={{ width: 128, height: 192, backgroundImage: `url(${book.imageLinks.thumbnail})` }}></div>
                  <div className="book-shelf-changer">
                    <select onChange={(e) => onChangeShelf(searchedBook, e.target.value)}>
